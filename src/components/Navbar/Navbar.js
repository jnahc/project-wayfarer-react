  ...
  return (
    <nav className="navbar navbar-expand-md navbar-dark navbar-color">
      <div className="container">
        <Link className="navbar-brand title-color"  to="/">Supreme Emperor</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarsExample04">
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              {props.currentUser && <NavLink className="nav-link title-color" exact to="/cities/san-francisco">Cities</NavLink>}
            </li>
